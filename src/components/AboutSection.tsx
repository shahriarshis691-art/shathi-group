...
export function AboutSection() {
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#0B0C0E] py-20 sm:py-24"
    >
      <div
        aria-hidden="true"
            ...
            <SlideIn key={title} direction={direction} delay={index * 0.08}>
              <ParallaxContainer depth="foreground" yRange={[28, -34]}>
                <article className="flex flex-col rounded-sm border border-neutral-800 bg-[#111215] p-7 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] transition-colors duration-300 hover:border-neutral-600 md:p-8">
                  ...
                  <h3 className="mb-3 font-serif text-lg font-normal tracking-tight text-neutral-100 md:text-xl">
                    {title}
                  </h3>
                  <p className="font-sans text-xs leading-relaxed tracking-normal text-neutral-400 md:text-[13px]">
                    {body}
                  </p>
                </article>
              </ParallaxContainer>

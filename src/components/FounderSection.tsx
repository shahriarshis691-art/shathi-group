          ...
          <SlideIn direction="left" className="lg:col-span-5">
            ...
            >
              <div className="relative mx-auto aspect-[4/5] w-full max-w-[420px] lg:mx-0">
                <div className="pointer-events-none absolute -bottom-4 -right-4 h-full w-full border border-neutral-700/60" aria-hidden="true" />
                <div className="relative h-full w-full overflow-hidden bg-neutral-900 shadow-md">
                  <Image
          ...
          <SlideIn direction="right" delay={0.12} className="lg:col-span-7">
            ...
            >
              <div className="mb-4 flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.25em] text-neutral-500">
                <span className="h-[1px] w-6 bg-neutral-700" aria-hidden="true" />
                Meet the Founder &amp; CEO
              </div>

              <h2
                id="founder-heading"
                className="mb-6 font-serif text-3xl font-normal leading-[1.15] tracking-tight text-white sm:text-4xl md:text-5xl"
              >
                A visionary approach to building enduring enterprises and modern experiences.
              </h2>

              <p className="mb-10 max-w-xl font-sans text-sm leading-relaxed text-neutral-400 md:text-base">
              ...
              <div className="grid grid-cols-1 gap-6 border-t border-neutral-800 pt-8 sm:grid-cols-3">
                <div>
                  <p className="font-serif text-3xl font-normal tracking-tight text-white md:text-4xl">
                    $10M+
                  </p>
              ...
              <a
                href="#founder-story"
                className="mt-6 inline-flex items-center gap-2 border-b border-white pb-1 font-mono text-xs uppercase tracking-[0.2em] text-white transition-colors hover:text-neutral-300"
              >
              ...
              <div className="mt-8">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-neutral-900 px-6 py-3 font-sans text-[11px] font-semibold uppercase tracking-[0.16em] text-white shadow-corporate transition hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-400 md:text-xs border border-neutral-800"
                >
                  Connect Directly
                  <ArrowUpRight className="h-4 w-4" aria-hidden />
                </button>

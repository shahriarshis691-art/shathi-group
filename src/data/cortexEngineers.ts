...
export const cortexEngineers: CortexEngineer[] = [
  ...
  },
  {
    ...
    projects: [
      { title: "Lattice Commerce OS", category: "High-performance commerce", description: "A composable commerce platform with a headless storefront, governed fulfilment flows, and a real-time customer operations desk.", metrics: ["2.1× conversion uplift", "Sub-second interactions", "Role-based operations"], image: "https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=1400&q=80", demoUrl: "/companies/cortex-softsolutions" },
      { title: "Keystone Identity Fabric", category: "Secure SaaS foundation", description: "A portable identity and permission layer that gives multi-tenant product teams a secure base for rapid delivery.", metrics: ["OIDC-first", "Full audit trail", "Tenant isolation"], image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1400&q=80", demoUrl: "/companies/cortex-softsolutions" },
    ],
  },
];
